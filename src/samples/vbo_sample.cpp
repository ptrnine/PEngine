...
int pe_main(args_view args) {
     ...
     * [2] [4] [5]
     */
    fill_side({  0.f, 0.f  }, {255,   0, 255}); // [0]
    fill_side({  0.f, 1/3.f}, {255, 127, 255}); // [1]
    fill_side({  0.f, 2/3.f}, {255, 200, 255}); // [2]
    fill_side({1/3.f, 1/3.f}, {  0, 255, 100}); // [3]
    fill_side({1/3.f, 2/3.f}, {  0, 255, 255}); // [4]
    fill_side({2/3.f, 2/3.f}, {127, 255, 255}); // [5]
